...
export default function StoriesOnAPlate() {
  const stories: Story[] = [
    {
      src: '/stories/rossini-nordic.png',
      caption:
    ...
    {
      src: '/stories/root-winter.png',
      caption: 'Winter Root Veloute - turnip and potato veloute, brown butter crumble, fresh black truffles.',
    },
    {
      src: '/stories/alaskan-crab.png',
      caption: 'Alaskan King Crab Leg - poached alaskan king crab, kaffir lime emulsion, white miso, kani salad.',
    },
    {
      src: '/stories/gravlax-mosaic.png',
      caption:
    ...
    {
      src: '/stories/bruschetta-pouch.png',
      caption:
    ...
    {
      src: '/stories/heirloom-veloute.png',
      caption:
    ...
    {
      src: '/stories/carrot-confidential.png',
      caption:
